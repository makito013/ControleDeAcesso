...
const tableRS = require("reactstrap").Table;
...
function handleClickLine(line, teste){console.log(teste);}
...
function (_React$Component) {
  ...
  _createClass(TreeTable, [{
      ...
      tableData.forEach(function (dataRow, index) {
        if (index >= startRow && index <= endRow) {
          ...
          tableBody.push(_react.default.createElement("tr", {
            className: rowClass,
            key: key,
            onClick: () => handleClickLine(dataRow),
          }, rowData));
    ...
    value: function render() {
      ...
      }, _react.default.createElement(tableRS, {
        responsive:true
